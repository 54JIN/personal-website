...
class Experience extends Component {
    ...
    onChange = (header, sub_title, info) => {
        this.setState({
            company: header,
            position: sub_title,
            details: info
